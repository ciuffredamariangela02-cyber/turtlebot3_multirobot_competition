...
def generate_launch_description():
    ...
    x_pose_r1 = LaunchConfiguration('x_pose', default='2.5')
    y_pose_r1 = LaunchConfiguration('y_pose', default='-1.5')

    x_pose_r2 = LaunchConfiguration('x_pose_r2', default='2.5')
    y_pose_r2 = LaunchConfiguration('y_pose_r2', default='-2.5')
